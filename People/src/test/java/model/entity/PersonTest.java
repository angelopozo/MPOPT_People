...
class PersonTest {
    ...
    void setUp() {
        ...
        personWithFullData = new Person(name, nif, email, phoneNumber, dateOfBirth, photo);
    }
    ...
    void testConstructorNameAndNif() {
       Person personWithNameAndNifAndPhoneNumber = new Person(name, nif, email, phoneNumber);
