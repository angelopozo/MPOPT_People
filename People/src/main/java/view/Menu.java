...
/**
 * This class defines the main menu of the application. Actions that can be done: insert, read, delete, update, readAll.
 *
...
public final class Menu extends javax.swing.JFrame {
    ...
    public void verificar() {
        if (loggedUser.length > 2 && loggedUser[2].equalsIgnoreCase("employee")) {
